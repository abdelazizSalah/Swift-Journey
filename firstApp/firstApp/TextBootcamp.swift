...
/*
  Important Notes:
 ---------------------
 1. The order of calling the utility methods, matter, actually I do not till now, why does it actually matter, but it does.
...
//            .strikethrough(true, color: Color.blue)
            ...
            .multilineTextAlignment(.leading) // this is how we align the text, in case that we have multilines., arguments options are .leading, .trailing, .center.
            .baselineOffset(20) //
            .kerning(4) // this is the spacing between each two letters.
            .foregroundColor(.black)
            .frame(width: 200, height: 200, alignment: .topLeading) // this determine the frame in which the text should be inserted in, like sizedBox in flutter.

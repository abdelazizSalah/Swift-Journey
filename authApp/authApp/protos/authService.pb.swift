...
struct AuthService_AccountCredentials: Sendable {
...
struct AuthService_OauthCredentials: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension AuthService_AccountCredentials: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AccountCredentials"
  ...
  static func ==(lhs: AuthService_AccountCredentials, rhs: AuthService_AccountCredentials) -> Bool {
...
extension AuthService_OauthCredentials: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".OauthCredentials"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    3: .same(proto: "token"),
  ...
  static func ==(lhs: AuthService_OauthCredentials, rhs: AuthService_OauthCredentials) -> Bool {
